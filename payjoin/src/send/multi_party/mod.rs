...
impl GetContext {
    ...
    pub fn process_response_and_finalize(
        ...
        let response = ohttp_decapsulate(ohttp_ctx, response_array).unwrap();
...
impl PsbtContext {
    fn process_proposal(self, mut proposal: Psbt) -> InternalResult<Psbt> {
        // TODO(armins) add multi-party check fees modeled after crate::send::PsbtContext::check_fees
